...
class Users(models.Model):
    username = models.CharField(max_length=10, unique=True, null=False,blank=True)
...
class PTcases(models.Model):
    pthost = models.URLField(null=False)
    url = models.URLField(null=False)
    method = models.CharField(max_length=10,null=False)
    headers = models.TextField(null=True)
    data = models.TextField(null=True)
    min_wait = models.IntegerField(default=1000)
    max_wait = models.IntegerField(default=3000)
    name = models.TextField(max_length=200,null=True)
    result = models.FileField(null=None)
